...
const Navbar = (props) => {
  ...
  return (
    <div >
      <nav className="flex justify-between items-center h-16 max-w-6xl mx-auto">
        ...
        <NavLink to="/">
          ...
          <div className="flex items-center font-medium text-slate-100 ml-auto space-x-6">
            ...
            <NavLink to="/cart">
              <div className="relative translate-x-[1000%]">
   ...
   <div className='flex justify-center items-center gap-x-3 translate-x-[20%] '>
        {!isLoggedIn &&
          <Link to='/login'>
